    ...
    <body>
        ...
        <div>
            ...
            <center>
                ...
                @endif
                <hr>
                <h2><b>Reporte de emergencias</b></h2>
                <hr>
            </center>
            ...
            <div style="width: 100%;padding:5px;box-sizing:border-box;">
                @if ($invoice->buyer->emergencies)

                <table class="table" style="width:100%">
                    <caption style="text-align: left;"><h4>Lista de emergencias</h4></caption>
                    <thead>
                      <tr>
                        <th scope="col">#</th>
                    ...
                    @if (count($invoice->buyer->emergencies) > 0)

                        @foreach($invoice->buyer->emergencies as $key => $value)
                            <tr>
